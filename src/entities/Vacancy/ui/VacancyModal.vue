      ...
      <div class="vacancy-modal__area">
        <label class="vacancy-modal__file-label">
          ...
          <img
            ...
            alt="Image preview"
            class="vacancy-modal__file-preview"
          />
        </label>
        <LabelWithIcon
          :type="'text'"
        ...
        <div class="vacancy-modal__social">
          <label
            class="vacancy-modal__social-label"
            v-for="(item, key) in vacancyModalSocial"
            :key="key"
          >
            <input
              type="checkbox"
              class="vacancy-modal__social-input"
              :name="'messengers'"
              :value="item.value"
              v-model="formData.messengers"
            />
