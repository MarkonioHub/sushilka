    ...
    <div class="cont">
      <div class="slider-offers__wrapper">
        <swiper
          ...
          :modules="modules"
          :loop="true"
          :pagination="{ el: '.slider-offers__pagination', clickable: true }"
          :navigation="{ prevEl: '.slider-offers__navigation_prev', nextEl: '.slider-offers__navigation_next' }"
          :speed="300"
          :autoplay="{ delay: 5000 }"
          :space-between="20"
        >
          <swiper-slide v-for="(item, id) in store.sliderOffers" :key="id">
            <img :src="item.image" :alt="item.alt" class="slider-offers__image" />
          </swiper-slide>
        </swiper>
        <div class="slider-offers__pagination"></div>
        <button class="slider-offers__navigation slider-offers__navigation_prev">
          <svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 330.002 330.002">
            <path
        ...
        <button class="slider-offers__navigation slider-offers__navigation_next">
          <svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 330.002 330.002">
            <path
              d="M233.252,155.997L120.752,6.001c-4.972-6.628-14.372-7.97-21-3c-6.628,4.971-7.971,14.373-3,21
              l105.75,140.997L96.752,306.001c-4.971,6.627-3.627,16.03,3,21c2.698,2.024,5.856,3.001,8.988,3.001
