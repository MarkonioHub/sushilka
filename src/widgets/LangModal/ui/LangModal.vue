...
const langOptions = [{ text: 'Русский', value: 'ru' }, { text: 'English', value: 'en' }]
  ...
  <ModalCustom :className="'modal-custom_delivery'" :id="'LangModal'">
    <div class="lang-modal">
      ...
      <LabelWithIcon
        ...
        :readonly="true"
      />
      <ButtonBase @click="saveLang" :className="'button-orange button-orange_big'" class="lang-modal__confirm">Ок</ButtonBase>
    </div>
  </ModalCustom>
</template>
